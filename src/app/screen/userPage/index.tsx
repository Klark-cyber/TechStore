...
export default function UserPage() {
  ...
  const {authMember} = useGlobals(); //GlobalContextga yuklangan authmember asosida userPageni shakllantiramiz
          ...
          <Stack className={"my-page-right"}>
            <Box className={"order-info-box"}>
              ...
              >
                ...
                <span className={"order-user-prof"}>{authMember?.memberAddres ? authMember.memberAddres : "No Addres"}</span>
              </Box>
